#!/usr/bin/env python3
"""
Electrify Agent (Strands SDK)

Strands equivalent of the LangGraph electrify_agent.py.
Connects to the Electrify MCP server and provides an energy assistant.
"""
