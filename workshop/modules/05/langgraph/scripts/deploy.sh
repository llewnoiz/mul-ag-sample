#!/bin/bash
# =============================================================
# Module 05v - Deploy to AgentCore - All Commands
# =============================================================
set -e
...
cd ~/workshop && uv run modules/05/langgraph/deploy_lambda.py \
...
uv run modules/05/langgraph/deploy_gateway_simple.py \
...
# Configure Agent
cd ~/workshop/modules/05/langgraph && uv run agentcore configure \
...
# Launch Agent
cd ~/workshop/modules/05/langgraph && uv run agentcore launch \
